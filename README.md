...
[Click here to view the network diagram](https://github.com/SeanJHenderson256/Cybersecurity/blob/main/Diagrams/project1diagram.png)
...
| DVWA 3   | Web Server  | 10.0.0.5   | Linux            |
...
|----------|---------------------|-------------------------------------------------------|
| Jump Box | Yes                 | manually configured for location of the admin         |
| ELK      | No                  | 10.0.0.1-254                                          |
...
Ansible was used to automate configuration of the ELK machine. No configuration was performed manually, which is advantageous because it allows for an optimal configuration that allocates resources automatically, is faster to implement, and less prone to error.
...
This ELK server is configured to monitor the DVWA 1, DVWA 2, and DVWA 3 VMs, at `10.0.0.7`, `10.0.0.9`, `10.0.0.5`, respectively.
...
The easiest way to copy the playbooks is to use Git. This copies the playbook files to the correct place;
